...
# Find the newest word list file in the du_cn_word_list directory
def get_newest_wordlist_file(directory):
...
# Example usage
wordlist_dir = 'du_cn_word_list'
file_path = get_newest_wordlist_file(wordlist_dir)
